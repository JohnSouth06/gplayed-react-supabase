...
import { badgeStyles, C, getPlatformInfo, getRatingColor, SORT_OPTIONS, styles } from './index.styles';

// ─── Composants UI Locaux (Déplacés depuis le bas du fichier) ──────────────
...
export default function DashboardScreen() {
  ...
  const fetchGames = async () => {
    try {
      // UTILISATION DE L'API (Plus de Supabase direct)
      ...
      // UTILISATION DE L'API POUR LE PROFIL
