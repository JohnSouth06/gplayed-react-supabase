...
import { badgeStyles, C, getBaseStyles, getPlatformInfo } from './index.styles';
import { getWishlistStyles } from './wishlist.styles';
                  ...
                  {detailTab === 'manage' ? (
                    <View style={defaultStyles.manageContainer}>
                      ...
                      <TouchableOpacity style={wishlistStyles.transferBtn} onPress={moveToCollection}>
                        <MaterialCommunityIcons name="library-plus" size={18} color={currentTheme.bg} />
