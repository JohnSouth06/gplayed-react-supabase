...
export const getProfileStyles = (theme: any, accentColor: string, accentColorDim: string) => {
  return {
    sectionStyles: StyleSheet.create({
      ...
      label: { color: accentColor, fontSize: 10, fontFamily: 'SpaceGrotesk_600SemiBold', textTransform: 'uppercase', letterSpacing: 2 },
    }),
    menuStyles: StyleSheet.create({
      ...
      label: { flex: 1, color: theme.textPrimary, fontSize: 14, fontFamily: 'SpaceGrotesk_600SemiBold' },
    }),
    styles: StyleSheet.create({
      ...
      avatarLetter: { color: accentColor, fontSize: 42, fontFamily: 'SpaceGrotesk_600SemiBold' },
      ...
      username: { color: theme.textPrimary, fontSize: 22, fontFamily: 'SpaceGrotesk_400Regular', letterSpacing: 0.3 },
      memberLabel: { color: theme.textMuted, fontSize: 12, fontFamily: 'SpaceGrotesk_300Light', marginTop: 5, textTransform: 'uppercase', letterSpacing: 1.5 },
      ...
      menuText: { flex: 1, color: theme.textPrimary, fontSize: 14, fontFamily: 'SpaceGrotesk_600SemiBold' },
      logoutBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 32, paddingVertical: 12 },
      logoutLabel: { color: theme.textMuted, fontSize: 14, fontFamily: 'SpaceGrotesk_600SemiBold' },
      ...
      segmentedLabel: { fontSize: 11, fontFamily: 'SpaceGrotesk_600SemiBold' },
