...
export const getUpdatePasswordStyles = (theme: any, accentColor: string, accentColorDim: string) => StyleSheet.create({
  ...
  title: { color: theme.textPrimary, fontSize: 22, fontFamily: 'SpaceGrotesk_400Regular', letterSpacing: 0.3 },
  ...
  strengthLabel: { fontSize: 11, fontFamily: 'SpaceGrotesk_700Bold', letterSpacing: 0.5, minWidth: 60, textAlign: 'right' },
  feedbackRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: -6, paddingHorizontal: 4 },
  feedbackText: { fontSize: 12, fontFamily: 'SpaceGrotesk_600SemiBold' },
  ...
  buttonText: { color: theme.bg, fontSize: 15, fontFamily: 'SpaceGrotesk_600SemiBold', letterSpacing: 1 },
});